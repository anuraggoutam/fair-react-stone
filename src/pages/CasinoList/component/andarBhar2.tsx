...
const AndarBhar2 = (props: any) => {
  ...
  const [CardSelection, setCardSelect] = useState<any>({
    type: 'yes',
    cards: [],
  });
  ...
  const ablayout = (index: number) => {
    ...
    const firstBetRunner =
      liveMatchData?.defaultMarkets?.[2]?.Runners?.[0] || {};
    const firstBetMarkets = lastOdds?.[firstBetRunner.SelectionId] || {};
    const secondBetRunner =
      liveMatchData?.defaultMarkets?.[3]?.Runners?.[0] || {};
    ...
    const firstBetRunnerB =
      liveMatchData?.defaultMarkets?.[2]?.Runners?.[1] || {};
    const firstBetMarketsB = lastOdds?.[firstBetRunnerB.SelectionId] || {};
    const secondBetRunnerB =
      liveMatchData?.defaultMarkets?.[3]?.Runners?.[1] || {};
          ...
          <div className="col-12 col-lg-6">
            <div className="bet-a" style={{ width: '100%' }}>
              ...
              <div className="sa">
                <div
                  className={
                    !saMarkets?.gstatus || saMarkets?.gstatus == '0'
                      ? 'suspended'
                      : ''
                  }
                  onClick={() => onBet(true, saMarkets)}
                >
                  <div>SA</div>
                ...
                <div className="book text-center">
                  <CasinoPnl
                    sectionId={saRunner.SelectionId}
              ...
              <div className="first-bet">
                <div
                  className={
                    !firstBetMarkets?.gstatus || firstBetMarkets?.gstatus == '0'
                      ? 'suspended'
                      : ''
                  }
                  onClick={() => onBet(true, firstBetMarkets)}
                >
                  <div>1st Bet</div>
                ...
                <div className="book text-center">
                  <CasinoPnl
                    sectionId={firstBetRunner.SelectionId}
                    matchId={liveMatchData?.match_id}
                    classData={'text-center'}
                  />
                </div>
              ...
              <div className="second-bet">
                <div
                  className={
                    !secondBetMarkets?.gstatus ||
                    secondBetMarkets?.gstatus == '0'
                      ? 'suspended'
                      : ''
                  }
                  onClick={() => onBet(true, secondBetMarkets)}
                >
                  <div>2nd Bet</div>
                ...
                <div className="book text-center">
                  <CasinoPnl
                    sectionId={secondBetRunner.SelectionId}
                    matchId={liveMatchData?.match_id}
                    classData={'text-center'}
                  />
                </div>
          ...
          <div className="col-12 col-lg-6">
            <div className="bet-a" style={{ width: '100%' }}>
              ...
              <div className="sa">
                <div
                  className={
                    !sbMarkets?.gstatus || sbMarkets?.gstatus == '0'
                      ? 'suspended'
                      : ''
                  }
                  onClick={() => onBet(true, sbMarkets)}
                >
                  <div>SB</div>
                ...
                <div className="book text-center">
                  <CasinoPnl
                    sectionId={sbRunner.SelectionId}
                    matchId={liveMatchData?.match_id}
                    classData={'text-center'}
                  />
                </div>
              ...
              <div className="first-bet">
                <div
                  className={
                    !firstBetMarketsB?.gstatus ||
                    firstBetMarketsB?.gstatus == '0'
                      ? 'suspended'
                      : ''
                  }
                  onClick={() => onBet(true, firstBetMarketsB)}
                >
                  <div>1st Bet</div>
                ...
                <div className="book text-center">
                  <CasinoPnl
                    sectionId={firstBetRunnerB.SelectionId}
                    matchId={liveMatchData?.match_id}
                    classData={'text-center'}
                  />
                </div>
              ...
              <div className="second-bet">
                <div
                  className={
                    !secondBetMarketsB?.gstatus ||
                    secondBetMarketsB?.gstatus == '0'
                      ? 'suspended'
                      : ''
                  }
                  onClick={() => onBet(true, secondBetMarketsB)}
                >
                  <div>2nd Bet</div>
                ...
                <div className="book text-center">
                  <CasinoPnl
                    sectionId={secondBetRunnerB.SelectionId}
                    matchId={liveMatchData?.match_id}
                    classData={'text-center'}
                  />
                </div>
          ...
          <div className="col-12 text-center card-seven">
            {market &&
              market.map((ItemN: any, indexRunner: number) => {
                return (
                  <div className="d-inline-block mrc-5" key={indexRunner}>
                    <CardItem
                      selectionid={ItemN.SelectionId}
                      title={`Card ${ItemN.RunnerName}`}
                      lastOdds={lastOdds}
            ...
            market.map((ItemN: any, indexRunner: number) => {
              ...
              const suspend =
                ...
                ItemMarket.gstatus == 'SUSPENDED'
                  ...
                  : '';
              let title =
                ItemN.RunnerName == 'Spade' ? (
                  <img src="/imgs/casino/spade.png" />
                ) : (
                  ItemN.RunnerName
                );
              title =
                title == 'Club' ? <img src="/imgs/casino/club.png" /> : title;
              title =
                title == 'Heart' ? <img src="/imgs/casino/heart.png" /> : title;
              title =
                title == 'Diamond' ? (
                  <img src="/imgs/casino/diamond.png" />
                ) : (
                  title
                );
              return (
                <div className={`${clsName} text-center`} key={indexRunner}>
                  <div className="bltitle">
                    <b>{title}</b>
                  </div>
                  <div
                    className={`back mt-1 blbox ${suspend}`}
                    onClick={() => onBet(true, ItemMarket)}
                  >
                    <span className="odd">{ItemMarket?.b1 || 0}</span>
                  </div>
                  <div className="mt-1">
                    {' '}
                    <CasinoPnl
  ...
  return (
    <div
      className="container teenpattixyz"
      style={{ marginTop: isMobile ? '-10px' : '' }}
    >
      <div className="row  ">
        <div
          className="col-lg-12 m-b-10 main-market "
          style={{ padding: '0px' }}
        >
          ...
          <div className="row ">
            <div className="col-lg-6">{layout6(4, 'col-6')}</div>
            <div className="col-lg-6">{layout6(5, 'col-3')}</div>
          </div>
          {layout4()}
        </div>
      </div>
