          ...
          <tr>
            <td style={{ width: '60%' }}>
              <table className="table coupon-table table table-bordered">
                <tbody data-title="SUSPENDED" className={`card32btbody`}>
                  <tr
                    style={{ height: isMobile ? '69px' : '89px' }}
                    key={2}
                    className={`${heightdata}`}
                  >
                    {[0, 1, 2, 3, 4].map((indexMarket: any, key: number) => {
                      const Item: any =
                        liveMatchData?.defaultMarkets?.[indexMarket]
                          ?.Runners?.[0] || {};
                      const ItemMarket: any =
                      ...
                      return (
                        <td
                          ...
                          className={`text-center bet-action back ${
                            selectionId == Item.SelectionId ? 'bg-green' : ''
                          }`}
            ...
            <td style={{ width: '40%' }}>
              <table className="table coupon-table table table-bordered">
                <tbody data-title="SUSPENDED" className={`card32btbody`}>
                  <tr
                    style={{ height: isMobile ? '59px' : '89px' }}
                    key={0}
                    className={`${heightdata}`}
                  >
      ...
      <table className="table coupon-table table table-bordered">
        ...
        <tbody data-title="SUSPENDED" className={`card32btbody ${clsstatus}`}>
          ...
          >
            {[0, 1, 2, 3, 4].map((indexMarket: any, key: number) => {
              const Item: any =
                liveMatchData?.defaultMarkets?.[indexMarket]?.Runners?.[0] ||
                {};
